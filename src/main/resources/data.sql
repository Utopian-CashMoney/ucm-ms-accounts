...
--Transactions
INSERT INTO `transaction` VALUES (1, 'CHKACCTNMBR', 100, CURRENT_TIMESTAMP(), 'SOMEONE GIV U $', 'COMPLETE', 'GIVER');
INSERT INTO `transaction` VALUES (2, 'CHKACCTNMBR', -100, CURRENT_TIMESTAMP(), 'SOMEONE TAK UR $', 'PENDING', 'TAKER');
